...
description: UZI deep stock analysis workflow. Use when the user asks for full equity research, valuation, DCF, comps, catalysts, earnings review, IC memo, initiation report, HTML report, or A-share/HK/US stock deep analysis.
license: MIT
metadata:
  tags: [finance, stocks, equity-research, valuation, dcf, a-share, hong-kong, us-stocks]
  related_skills: [uzi-investor-panel, uzi-lhb-analyzer, uzi-trap-detector]
---
