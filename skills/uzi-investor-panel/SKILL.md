...
description: UZI investor-panel review. Use when the user asks which famous investors would buy, hold, avoid, or debate a stock; wants a multi-investor jury vote; or needs value/growth/quant/youzi perspectives on a holding.
license: MIT
metadata:
  tags: [finance, investor-panel, voting, value-investing, growth-investing, a-share]
