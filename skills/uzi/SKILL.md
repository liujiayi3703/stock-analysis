---
name: uzi
description: UZI stock-research suite root. Use when the user mentions UZI, UZI-Skill, deep stock research, valuation, investor panel, hot-money/LHB analysis, trap detection, IC memo, Bloomberg-style equity research, A-share, HK, or US stock analysis.
license: MIT
metadata:
  tags: [finance, stocks, a-share, hong-kong, us-stocks, valuation, investor-panel, youzi, lhb, trap-detection]
  related_skills: [uzi-deep-analysis, uzi-investor-panel, uzi-lhb-analyzer, uzi-trap-detector]
---
